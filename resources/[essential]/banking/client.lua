...
-- Send NUI Message to display add balance popup
RegisterNetEvent("banking:adddBalance")
AddEventHandler("banking:adddBalance", function(amount)
  SendNUIMessage({
    adddBalance = true,
    damount = amount
  })
...
-- Send NUI Message to display remove balance popup
RegisterNetEvent("banking:removedBalance")
AddEventHandler("banking:removedBalance", function(amount)
  SendNUIMessage({
    removedBalance = true,
    damount = amount
  })
...
RegisterNetEvent("banking:setBankDisplay")
AddEventHandler("banking:setBankDisplay", function(val)
	SendNUIMessage({
		setDisplay = true,
		display = val
	})
